...
export class MusteriServiceProxy {
     ...
     * @return Success
     */
    musteriGuncelle(body: MusteriGuncelleDto | undefined): Observable<void> {
...
export class ProjeServiceProxy {
     ...
     * @return Success
     */
    getProjeListMusteri(musteriId: number | undefined): Observable<Proje[]> {
    ...
    protected processGetProjeListMusteri(response: HttpResponseBase): Observable<Proje[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(Proje.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return Success
     */
    projeEkle(body: ProjeEkleDto | undefined): Observable<void> {
    ...
    protected processProjeEkle(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    projeGuncelle(body: ProjeGuncelleDto | undefined): Observable<void> {
...
export class Gorev implements IGorev {
    id: number;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.developer = _data["developer"] ? User.fromJS(_data["developer"]) : <any>undefined;
    ...
    static fromJS(data: any): Gorev {
        data = typeof data === 'object' ? data : {};
        let result = new Gorev();
        result.init(data);
        return result;
    }
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["developers"])) {
                this.developers = [] as any;
                for (let item of _data["developers"])
                    this.developers.push(UserDto.fromJS(item));
            }
            this.durum = _data["durum"];
        }
    }
